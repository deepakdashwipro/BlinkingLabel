...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Deepak Kumar Dash/BlinkingLabel'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Deepak Kumar Dash' => 'deepak.k.dash@gsk.com' }
  s.source           = { :git => 'https://github.com/Deepak Kumar Dash/BlinkingLabel.git', :tag => s.version.to_s }
